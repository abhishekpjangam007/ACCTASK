...
TextView spt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///////
        UnityAds.initialize(safeplaces.this,unityGameID,testMode);
...
//        }
        ...
        ////
    bcksp=findViewById(R.id.bcksp);
        final MediaPlayer mediaplayer = MediaPlayer.create(this,R.raw.click);
    bcksp.setOnClickListener(new View.OnClickListener() {
        @Override
...
//                        progressDialog.dismiss();
    ...
    private void DisplayInterstitialAd () {
        if (UnityAds.isReady(interstatial_id)){
            UnityAds.show(safeplaces.this,interstatial_id);
        }
    }
    @Override
    public void onBackPressed() {

                Intent intent = new Intent(safeplaces.this, tricksntips.class);
