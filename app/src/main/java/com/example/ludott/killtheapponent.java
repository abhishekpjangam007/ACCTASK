...
public class killtheapponent extends AppCompatActivity {
private ImageView bckkta,hmk;
TextView kta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_killtheapponent);
        ...
        /////
        UnityAds.initialize(killtheapponent.this,unityGameID,testMode);
...
//        }
        ...
        ////
    bckkta=findViewById(R.id.bckkta);
        final MediaPlayer mediaplayer = MediaPlayer.create(this,R.raw.click);
    bckkta.setOnClickListener(new View.OnClickListener() {
        @Override
...
//                    progressDialog.setMessage("Add is Loading...");
//
//                    progressDialog.show();
...
//                        @Override
//                        public void run() {
//                            Intent intent = new Intent(killtheapponent.this, MainActivity.class);
...
//                }
    ...
    private void DisplayInterstitialAd () {
        if (UnityAds.isReady(interstatial_id)){
            UnityAds.show(killtheapponent.this,interstatial_id);
        }
    }
    @Override
    public void onBackPressed() {

                Intent intent = new Intent(killtheapponent.this, tricksntips.class);
                startActivity(intent);
